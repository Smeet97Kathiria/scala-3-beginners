...
object CaseClasses {
  ...
  // 2 - toString, equals and hashCode <- methods automatically generated by compiler for case classes
  ...
  */
  ...
  case object UnitedKingdom { // use case for case objects -> toString, equals and hashCode , serializable
    // fields and methods
